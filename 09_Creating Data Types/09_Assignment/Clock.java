public class Clock {
    ...
    public boolean isEalierThan(Clock that) {
    ...
    public void toc(int delta) {
        ...
        this.hour = (this.hour + temp / MINUTES) % HOURS;
    }

    // test client
    public static void main(String[] args) {
        Clock clock1 = new Clock(23, 02);
        Clock clock2 = new Clock("05:08");

        StdOut.println("Clock 1: " + clock1.toString());
        StdOut.println("Clock 2: " + clock2.toString());

        StdOut.println("Clock 1 is ");
        if (!clock1.isEalierThan(clock2))
            StdOut.print("not ");
